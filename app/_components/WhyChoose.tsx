                ...
                >
                  <div className="flex items-center justify-between w-full relative px-4 md:px-8">
                    ...
                    <div className="z-10 shrink-0 ml-auto">
                       <div 
                          className={`relative overflow-hidden flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full border transition-all duration-500 ${
                            isOpen ? 'border-gray-300 bg-white shadow-sm' : 'border-white/20 bg-transparent group-hover:border-white/50 group-hover:bg-white/10'
                          }`}
                       >
